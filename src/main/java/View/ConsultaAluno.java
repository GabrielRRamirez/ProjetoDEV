...
public class ConsultaAluno extends javax.swing.JInternalFrame {
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
       ...
       if(linhaSelecionada >= 0){
           ...
           int id =(Integer.parseInt(tblAluno.getValueAt(linhaSelecionada, 0).toString()));
           alunoSelecionado = controller.getAlunos(id, "").get(0);
           CadastroAluno frmCadastro = new CadastroAluno(alunoSelecionado);
